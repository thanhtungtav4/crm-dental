...
class PatientForm
{
    ...
    {
        return Section::make('Định danh hồ sơ')
            ->description('Chốt chi nhánh, khách hàng liên kết và thông tin cá nhân cốt lõi trước khi phân công hồ sơ.')
            ->schema([
                ...
                Forms\Components\TextInput::make('patient_code')
                    ->label('Mã bệnh nhân')
                    ->helperText('Tự động sinh, chỉ hiển thị khi chỉnh sửa hồ sơ.')
                    ->maxLength(50)
    ...
    {
        return Section::make('Liên hệ & tiếp nhận')
            ->description('Điền cách liên hệ chính và lý do đến khám để tuyến trước có đủ ngữ cảnh khi chăm sóc.')
            ->schema([
    ...
    {
        return Section::make('Phân nhóm & phụ trách')
            ->description('Dùng nhóm hồ sơ và người phụ trách để danh sách bệnh nhân dễ lọc, dễ giao việc hơn.')
            ->schema([
    ...
    protected static function clinicalNotesSection(): Section
    {
        return Section::make('Ghi chú lâm sàng')
            ->description('Gói các lưu ý y khoa và ghi chú nội bộ vào một khối dễ đọc để tránh bỏ sót khi tiếp nhận.')
            ->schema([
