...
| EMR-11 | P0 | Done (`2026-03-03`) | Clinical media domain core | `clinical_media_assets/versions/access_logs`, checksum, linkage encounter/session, immutable original | pending |
