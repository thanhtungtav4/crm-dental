...
- xem tài khoản mẫu ở [../getting-started/local-demo-users.md](../getting-started/local-demo-users.md)
...
- lễ tân / tư vấn / CSKH: [Hướng dẫn Lễ tân / CSKH](frontdesk-cskh.md)
- bác sĩ: [Hướng dẫn Bác sĩ](doctor.md)
- quản lý / admin: [Hướng dẫn Quản lý / Admin](manager-admin.md)
