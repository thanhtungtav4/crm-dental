...
- Progress update:
  ...
  - `RRB-010` da bo sung `PatientOverviewReadModelService` de `PatientOverviewWidget` va payment summary trong `ViewPatient` dung chung patient workspace aggregate contract, loai bo them mot lop invoice/payment/appointment/treatment-plan count query khoi widget/page layer.
