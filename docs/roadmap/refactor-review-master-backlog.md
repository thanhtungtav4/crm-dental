...
- Recommended direction:
  ...
  - Tien do hien tai:
    ...
    - da bo sung `PatientOverviewReadModelService` cho `PatientOverviewWidget` va payment summary tren `ViewPatient`, de patient workspace khong con tu giu treatment-plan / appointment / invoice / payment aggregate query truc tiep trong widget va page property
