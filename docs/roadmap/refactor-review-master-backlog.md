...
- Recommended direction:
  ...
  - Tien do hien tai:
    ...
    - da tao `FinancialDashboardReadModelService` de gom payment/invoice aggregate contract cho `RevenueOverviewWidget`, `OutstandingBalanceWidget`, `QuickFinancialStatsWidget`, `MonthlyRevenueChartWidget`, va `PaymentMethodsChartWidget`, de lane dashboard tai chinh branch-scoped khong con lap lai cung mot set query trong tung widget
