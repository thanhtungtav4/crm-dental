...
- Recommended direction:
  ...
  - Tien do hien tai:
    ...
    - da bo sung `PatientOverviewReadModelService` cho `PatientOverviewWidget`, payment summary, tab counters, material usages, factory orders, va material issue notes tren `ViewPatient`, de patient workspace khong con tu giu treatment-plan / appointment / invoice / payment / tab-count / lab-material aggregate query truc tiep trong widget va page property
