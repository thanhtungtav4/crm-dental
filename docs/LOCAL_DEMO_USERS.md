...
| --- | --- | --- | --- |
| `admin@demo.ident.test` | `Admin` | `HCM-Q1` | Quan tri toan he thong, review settings, audit, KPI |
| `automation.bot@demo.ident.test` | `AutomationService` | `none` | Service account cho scheduler / OPS control-plane, khong vao Filament panel |
| `manager.q1@demo.ident.test` | `Manager` | `HCM-Q1` | Demo quan ly co so Quan 1 |
| `manager.cg@demo.ident.test` | `Manager` | `HN-CG` | Demo quan ly co so Cau Giay |
| `manager.hc@demo.ident.test` | `Manager` | `DN-HC` | Demo quan ly co so Hai Chau |
| `doctor.q1@demo.ident.test` | `Doctor` | `HCM-Q1` | Demo luong kham / dieu tri / lich hen Quan 1 |
| `doctor.cg@demo.ident.test` | `Doctor` | `HN-CG` | Demo luong kham / dieu tri / lich hen Cau Giay |
| `doctor.hc@demo.ident.test` | `Doctor` | `DN-HC` | Demo luong kham / dieu tri / lich hen Hai Chau |
| `doctor.float@demo.ident.test` | `Doctor` | `HCM-Q1` | Bac si da chi nhanh, co branch assignment tai `HN-CG` de demo branch scope |
| `cskh.q1@demo.ident.test` | `CSKH` | `HCM-Q1` | Demo lead/care queue Quan 1 |
| `cskh.cg@demo.ident.test` | `CSKH` | `HN-CG` | Demo lead/care queue Cau Giay |
| `cskh.hc@demo.ident.test` | `CSKH` | `DN-HC` | Demo lead/care queue Hai Chau |
...
| --- | --- | --- | --- |
| `Nguyen Thi Thu Trang` | `0909123001` | `HCM-Q1` | Tu van implant, co lich hen confirmed, invoice partial, ZNS recall completed |
| `Tran Quoc Huy` | `0909123002` | `HCM-Q1` | Dieu tri rang su, co lich completed, invoice paid, factory order dang ordered |
| `Le Van Nam` | `0912123004` | `HN-CG` | Demo doctor da chi nhanh tai Cau Giay, co branch transfer log |
| `Vu Thi Hong Nhung` | `0912123005` | `HN-CG` | No-show recovery / reschedule / invoice overdue / ZNS scheduled |
| `Hoang Thi Bich Van` | `0935123007` | `DN-HC` | No-show case cho luong CSKH goi lai |
| `Phan Ngoc Anh` | `0935123008` | `DN-HC` | Ca implant / labo urgent / lich hen cancelled |
...
- Login bang `admin@demo.ident.test`
- Xac nhan `Manager` khong CRUD `User`, `Role`, `Branch`

### Demo branch scope

- Login bang `manager.q1@demo.ident.test`
- Mo patient/appointment tai `HCM-Q1`
- Doi sang `doctor.float@demo.ident.test` de demo doctor co the lam viec tai nhieu chi nhanh

### Demo CSKH

- Login bang `cskh.q1@demo.ident.test`
...
- Login bang `doctor.cg@demo.ident.test`
...
- Login bang `manager.hc@demo.ident.test`
