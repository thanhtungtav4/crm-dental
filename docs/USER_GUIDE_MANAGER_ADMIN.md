...
- thao tác hàng ngày cho user thường: [Bắt đầu nhanh](USER_GUIDE_GETTING_STARTED.md)
- luồng khách hàng và lịch hẹn: [Lễ tân / CSKH](USER_GUIDE_FRONTDESK_CSKH.md)
- luồng khám điều trị: [Bác sĩ](USER_GUIDE_DOCTOR.md)
