# Prompt Pack: Module Review Pipeline
...
- `docs/issues/*.md`: canonical issue register cua module
- `docs/planning/*.md`: canonical implementation plan va task register cua module
...
- Issue file: docs/issues/[MODULE-CODE]-issues.md
- Plan file: docs/planning/[MODULE-CODE]-plan.md
...
## File path
`docs/issues/[MODULE-CODE]-issues.md`
...
## File path dau ra
`docs/planning/[MODULE-CODE]-plan.md`
