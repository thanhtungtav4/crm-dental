...
| ZNS | Zalo / ZNS | In Fix | [Review](modules/ZNS-zalo-zns.md) | [Issues](../issues/ZNS-issues.md) | [Plan](../planning/ZNS-plan.md) | D | Workflow campaign va cancel-processing guard da khoa; PII plaintext va campaign-level lock van ho | PAT, APPT, CARE, INT, OPS |
...
- `ZNS` dang o phase fix; auth boundary, workflow campaign canonical va cancel-processing guard da duoc khoa, nhung payload governance va campaign-level lock van con mo.
...
- `ZNS` - dang trong phase fix; tiep theo la `TASK-ZNS-004`, `TASK-ZNS-005`, `TASK-ZNS-007`.
...
- `ZNS` - dang fix; tiep tuc `TASK-ZNS-004`, `TASK-ZNS-005`, `TASK-ZNS-007`.
