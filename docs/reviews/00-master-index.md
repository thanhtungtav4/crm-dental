...
| SUP | Suppliers / Factory Orders | In Fix | [Review](modules/SUP-suppliers-factory.md) | [Issues](../issues/SUP-issues.md) | [Plan](../planning/SUP-plan.md) | D | Workflow mutation surfaces, report datasource va coverage SUP van con mo | INV, FIN, GOV |
...
- `SUP` - dang active fix; batch tiep theo la `TASK-SUP-005`.
...
- `SUP` - tiep tuc `TASK-SUP-005` de khoa workflow mutation boundary cua order/item.
