...
| ZNS | Zalo / ZNS | In Fix | [Review](modules/ZNS-zalo-zns.md) | [Issues](../issues/ZNS-issues.md) | [Plan](../planning/ZNS-plan.md) | D | Workflow campaign chua canonical; cancel-vs-processing race va PII plaintext van ho | PAT, APPT, CARE, INT, OPS |
...
- `ZNS` dang o phase fix; auth boundary cho page/resource/command da duoc khoa, nhung workflow campaign canonical, cancel-vs-processing race va payload governance van con mo.
...
- `ZNS` - dang trong phase fix; tiep theo la `TASK-ZNS-002` va `TASK-ZNS-003`.
...
- `ZNS` - dang fix; tiep tuc `TASK-ZNS-002`, `TASK-ZNS-003`, `TASK-ZNS-004`.
