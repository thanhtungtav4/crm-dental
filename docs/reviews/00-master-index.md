...
| ZNS | Zalo / ZNS | In Fix | [Review](modules/ZNS-zalo-zns.md) | [Issues](../issues/ZNS-issues.md) | [Plan](../planning/ZNS-plan.md) | D | Workflow campaign da canonical; cancel-vs-processing race, PII plaintext va campaign-level lock van ho | PAT, APPT, CARE, INT, OPS |
...
- `ZNS` dang o phase fix; auth boundary va workflow campaign canonical da duoc khoa, nhung cancel-vs-processing race, payload governance va campaign-level lock van con mo.
...
- `ZNS` - dang trong phase fix; tiep theo la `TASK-ZNS-003`, `TASK-ZNS-004`, `TASK-ZNS-005`.
...
- `ZNS` - dang fix; tiep tuc `TASK-ZNS-003`, `TASK-ZNS-004`, `TASK-ZNS-005`.
