    ...
    <form wire:submit="save" class="space-y-6">
        @foreach($this->getProviders() as $provider)
            <x-filament::section :heading="$provider['title']" :description="$provider['description']">
                ...
                @if(($provider['group'] ?? null) === 'zalo')
                    <div class="mt-4 flex flex-wrap gap-2">
                        <x-filament::button type="button" color="gray" icon="heroicon-o-shield-check" wire:click="testZaloReadiness">
                            Đánh giá sẵn sàng Zalo OA
                        </x-filament::button>
                    </div>
                ...
                @if(($provider['group'] ?? null) === 'zns')
                    <div class="mt-4 flex flex-wrap gap-2">
                        <x-filament::button type="button" color="gray" icon="heroicon-o-shield-check" wire:click="testZnsReadiness">
                            Đánh giá sẵn sàng ZNS
                        </x-filament::button>
                    </div>
                @endif
