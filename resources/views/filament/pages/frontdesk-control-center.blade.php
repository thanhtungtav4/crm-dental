...
<x-filament-panels::page>
    <div class="space-y-6">
        ...
        <x-filament::section heading="Lối tắt front-office" description="Đi thẳng tới các màn hình hot-path mà không cần tìm lại trong menu.">
            <div class="grid gap-4 md:grid-cols-2 xl:grid-cols-5">
                @foreach($this->getQuickLinks() as $link)
                    <a
                        href="{{ $link['url'] }}"
                        class="rounded-2xl border border-gray-200 bg-white px-4 py-4 transition hover:border-primary-300 hover:bg-primary-50/40 dark:border-gray-800 dark:bg-gray-950/60 dark:hover:border-primary-700 dark:hover:bg-primary-950/20"
                    >
                        <div class="space-y-2">
