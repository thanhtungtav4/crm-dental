                                    ...
                                    <div class="crm-tooth-chart">
                                        <div class="crm-tooth-toolbar mb-3" style="display: flex; flex-wrap: wrap; align-items: center; justify-content: space-between; gap: 8px;">
                                            ...
                                            <div class="crm-tooth-toolbar-actions" style="display: flex; flex-wrap: wrap; align-items: center; gap: 8px;">
                                                <span class="crm-selection-chip" style="display: inline-flex; align-items: center; min-height: 30px; padding: 0 10px; border: 1px solid var(--crm-border, #d1d5db); border-radius: 7px; background: var(--crm-surface-elevated, #fff); font-size: 12px; font-weight: 700; color: var(--crm-text-body, #475569);">Đã chọn: <span x-text="selectedTeeth.length"></span></span>
